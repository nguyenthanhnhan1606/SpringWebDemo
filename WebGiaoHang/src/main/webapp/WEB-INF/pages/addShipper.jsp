        ...
        <div class="col-md-6 offset-md-3">
            ...
            <form:form method="post" action="${action}" modelAttribute="userUpdate" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    <form:input type="text" class="form-control" path="ten" id="ten" placeholder="Tên người dùng..." />
                    <label for="ten">Họ tên</label>
                    <form:errors path="ten" element="div" cssClass="text-danger" />
                </div>

                <div class="form-floating mb-3">
                    <form:input type="date" class="form-control" path="ngaysinh" id="ngaysinh" placeholder="Ngày sinh..." />
                ...
                <div class="form-select mb-3">
                    ...
                    <form:select path="gioitinh" class="form-control" id="gioitinh">
                ...
                <div class="form-floating mb-3">
                    <form:input type="text" class="form-control" path="email" id="email" placeholder="Email người dùng..." />
                    <label for="email">Email </label>
                    <form:errors path="email" element="div" cssClass="text-danger" />
                </div>

                <div class="form-floating mb-3">
                    <form:input type="text" class="form-control" path="sdt" id="sdt" placeholder="Số điện thoại người dùng..." />
                    <label for="sdt">Số điện thoại </label>
                    <form:errors path="sdt" element="div" cssClass="text-danger" />
                </div>

                <div class="form-floating mb-3">
                    <form:input type="text" class="form-control" path="cmnd" id="cmnd" placeholder="Số điện thoại người dùng..." />
