...
//        http.csrf().disable();
        ...
        http.authorizeRequests().antMatchers("/api/shippers/**").permitAll();
        http.authorizeRequests().antMatchers("/api/binhluan/**").permitAll();
        http.authorizeRequests().antMatchers("/api/danhgia/**").permitAll();
        http.authorizeRequests().antMatchers("/api/register/**").permitAll();
        http.antMatcher("/api/**").httpBasic().authenticationEntryPoint(restServicesEntryPoint()).and()
                .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().authorizeRequests()
                .antMatchers(HttpMethod.GET, "/api/**").access("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER') or hasRole('ROLE_SHIPPER')")
